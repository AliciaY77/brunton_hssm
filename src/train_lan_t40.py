...
LABELED_PATH   = pathlib.Path(__file__).resolve().parents[1] / "train_data" / "brunton_labeled_t40.pickle"
MODEL_SAVE_DIR = pathlib.Path(__file__).resolve().parents[1] / "train_data" / "trained_lan_t40"
...
def main():
    ...
    onnx_path = str(MODEL_SAVE_DIR / "brunton_t40.onnx")
