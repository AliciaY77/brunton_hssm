...
DATA_PATH  = pathlib.Path(__file__).resolve().parents[1] / "train_data" / "brunton_training_data.npy"
OUT_PATH   = pathlib.Path(__file__).resolve().parents[1] / "train_data" / "brunton_labeled.pickle"
