...
Usage:
    python src/param_recovery_t40.py
    python src/param_recovery_t40.py --n_trials 500  # small/fast version
"""
import argparse
import pathlib
import numpy as np
...
ONNX_PATH = pathlib.Path(__file__).resolve().parents[1] / "train_data" / "trained_lan_t40" / "brunton_t40.onnx"
OUT_PATH  = pathlib.Path(__file__).resolve().parents[1] / "train_data" / "param_recovery_t40"
